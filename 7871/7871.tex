...
%\hspace{-6cm}
\begin{tabular}{p{7pt}|l|p{6pt}p{6pt}p{6pt}p{6pt}p{6pt}p{6pt}p{6pt}p{6pt}p{6pt}p{6pt}p{6pt}p{6pt}p{6pt}p{6pt}p{6pt}p{6pt}}% @{}}
\multicolumn{17}{c}{График выполнения лабораторных работ студентами 7871 группы} \\ 
...
\midrule
 ...
 4\,&Давыдов Максим Сергеевич (ст.)    \ok\ok\ok\ok\ok\ok\ok\ok\dab\ok\dc\ok\ok\ok   \ok\\
 ...
 9\,&Лысенко Михаил Владимирович       \ok\ok\ok\ok\ok\ok\ok\ok\ok \ok\ok\ok\ok\ok   \ok\\
...
17\,&Тузов Никита Павлович             \ok\ok\ok\ok\ok\ok\ok\ok\ok \ok\ok\ok\ok\da   \ok\\
